...
router.get('/', auth(), (req, res) => {
    const opts = { populate: [{ path: 'user', select: 'firstName lastName fullName socketId' }, { path: 'comments', populate: { path: 'user', select: 'firstName lastName fullName' } }], lean: false }
